    ...
    >
      <Flex gap={8} direction={{ base: 'column', md: 'row' }} bg="gray.50" p={6} borderRadius="lg" minH="70vh">
        <Box flex={{ base: 1, md: 0 }} minW={{ base: 'full', md: '300px' }}>
          <StructureSidebar currentPath="/struktur/metodikikabinet" />
        </Box>
        ...
        <Box flex={1}>
          <VStack spacing={8} align="stretch">
            ...
            >
              ...
              />
              <Image
                src="/images/metodikikabinet.jpg"
                alt="Metodiki Kabinet"
                width={800}
                height={500}
                style={{ 
                  width: '100%', 
            ...
            <VStack spacing={3} align="stretch" bg="white" p={6} borderRadius="xl" boxShadow="sm">
              <Text fontSize="4xl" fontWeight="bold">Metodiki Kabinet</Text>
              <Text fontSize="xl" color="gray.600" mb={4}>Ad Soyad</Text>
              <Text color="gray.700" lineHeight="tall">
                Metodiki kabinetin təhsil və fəaliyyəti haqqında məlumat
                <br />
                Təhsil və təhsil nəzarətliyində metodiki kabinet müdiri vəzifəsində çalışmışdır.
                <br />
                2024-cü il tarixində UNEC nəzdində Sosial-İqtisadi  Kollecinə  metodiki kabinet təyin edilib.
              </Text>
            </VStack>
          </VStack>
        </Box>
